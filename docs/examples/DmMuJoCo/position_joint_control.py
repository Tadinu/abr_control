...
sim_interface = AbrMujoco(robot_config=robot_config, dt=DT, visualize=True, create_offscreen_rendercontext=OFFSCREEN_RENDERING)
...
count = 0
def tick():
    global sim_interface, robot_config, ctrlr, count, q_track, target, count
    if count>=2500:
